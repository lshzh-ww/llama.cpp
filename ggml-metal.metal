...
kernel void kernel_cpy(
        ...
        constant  uint64_t & nb3,
        uint tpig[[thread_position_in_grid]]) {
    const int64_t i03 = tpig / (ne02*ne01*ne00);
    const int64_t i02 = (tpig - i03*ne02*ne01*ne00) / (ne01*ne00);
    const int64_t i01 = (tpig - i03*ne02*ne01*ne00 - i02*ne01*ne00) / ne00;
    const int64_t i00 = (tpig - i03*ne02*ne01*ne00 - i02*ne01*ne00 - i01*ne00);

    const int64_t i3 = tpig / (ne2*ne1*ne0);
    const int64_t i2 = (tpig - i3*ne2*ne1*ne0) / (ne1*ne0);
    const int64_t i1 = (tpig - i3*ne2*ne1*ne0 - i2*ne1*ne0) / ne0;
    const int64_t i0 = (tpig - i3*ne2*ne1*ne0 - i2*ne1*ne0 - i1*ne0);

    device Td * dst_data = (device Td *) ((device char *) dst + i3*nb3 + i2*nb2 + i1*nb1 + i0*nb0);
    device const Ts * src = (device Ts *)((device char *) src0 + i03*nb03 + i02*nb02 + i01*nb01 + i00*nb00);

    if (tpig<ne03*ne02*ne01*ne00){
        dst_data[0] = src[0];
    }
}

template [[host_name("kernel_cpy_f16_f16")]] kernel void kernel_cpy(device const half *, device half *, \
        constant  int64_t &, constant  int64_t &, constant  int64_t &, constant  int64_t &, \
        constant uint64_t &, constant uint64_t &, constant uint64_t &, constant uint64_t &, \
        constant  int64_t &, constant  int64_t &, constant  int64_t &, constant  int64_t &, \
        constant uint64_t &, constant uint64_t &, constant uint64_t &, constant uint64_t &, uint);

template [[host_name("kernel_cpy_f32_f16")]] kernel void kernel_cpy(device const float *, device half *, \
        constant  int64_t &, constant  int64_t &, constant  int64_t &, constant  int64_t &, \
        constant uint64_t &, constant uint64_t &, constant uint64_t &, constant uint64_t &, \
        constant  int64_t &, constant  int64_t &, constant  int64_t &, constant  int64_t &, \
        constant uint64_t &, constant uint64_t &, constant uint64_t &, constant uint64_t &, uint);

template [[host_name("kernel_cpy_f32_f32")]] kernel void kernel_cpy(device const float *, device float *, \
        constant  int64_t &, constant  int64_t &, constant  int64_t &, constant  int64_t &, \
        constant uint64_t &, constant uint64_t &, constant uint64_t &, constant uint64_t &, \
        constant  int64_t &, constant  int64_t &, constant  int64_t &, constant  int64_t &, \
        constant uint64_t &, constant uint64_t &, constant uint64_t &, constant uint64_t &, uint);
